...
```mermaid
  graph TD;
       Εκμάθηση_διαδικασίας --> τρίψιμο_παλαμών_5_sec;
      Εκμάθηση_διαδικασίας --> τρίψιμο_παλάμης_με_την_αντίθετη_ραχαία_επιφάνεια_του_χεριού_5_sec;
      Εκμάθηση_διαδικασίας --> τρίψιμο_επιφανειών_ανάμεσα_στα_δάχτυλα_5_sec;
       Εκμάθηση_διαδικασίας --> τρίψιμο_πίσω_μέρος_των_δαχτύλων_5_sec;
       Εκμάθηση_διαδικασίας --> τρίψιμο_με_κυκλικές_κινήσεις_τους_αντίχειρες_5_sec;
       Εκμάθηση_διαδικασίας --> τρίψιμο_το_εσωτερικό_των_παλαμών_με_τα_ακροδάχτυλα_5_sec;
```
```mermaid
  graph TD;
      Χρονομέτρηση --> 60sec;
