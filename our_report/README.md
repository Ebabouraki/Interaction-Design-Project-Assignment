...
```mermaid
  graph TD;
     ...
     5_sec --> τρίψιμο_επιφανειών_ανάμεσα_στα_δάχτυλα;
      5_sec --> τρίψιμο_πίσω_μέρος_των_δαχτύλων;
       5_sec --> τρίψιμο_με_κυκλικές_κινήσεις_τους_αντίχειρες;
...
```mermaid
  graph TD;
       Διεπαφή_δραστηριοτηρας --> οπτική_επαφή;
        Διεπαφή_δραστηριοτηρας --> ακουστική_επαφή;
         Διεπαφή_δραστηριοτηρας --> αφή;
